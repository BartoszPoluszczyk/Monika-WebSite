...
- `monika-kulik-logo-original.svg` — niezmieniona kopia dostarczonego logo
  `Monika_Kulik_logo_wektorowe.svg`, z białym tłem i pionowym układem.
...
nierównościami przy dużym powiększeniu. Nie jest gotowym projektem banera
do druku; przed dużym wydrukiem warto skorygować kontury i przygotować
projekt według wymagań drukarni.
